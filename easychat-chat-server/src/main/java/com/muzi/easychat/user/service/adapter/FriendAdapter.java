...
import com.muzi.easychat.user.domain.entity.UserApply;
import com.muzi.easychat.user.domain.entity.UserFriend;
import com.muzi.easychat.user.domain.vo.req.friend.FriendApplyReq;
import com.muzi.easychat.user.domain.vo.resp.friend.FriendApplyResp;
import com.muzi.easychat.user.domain.vo.resp.friend.FriendResp;
...
import static com.muzi.easychat.user.domain.enums.ApplyReadStatusEnum.UNREAD;
import static com.muzi.easychat.user.domain.enums.ApplyStatusEnum.WAIT_APPROVAL;
import static com.muzi.easychat.user.domain.enums.ApplyTypeEnum.ADD_FRIEND;
